...
class Dielectric_function_slab:
    def __init__(self, filename, qp, point_dens, omega, d, eta, n):
        self.q_paral = qp
        self.thickness = d
    ...
    def add_loss_func_test0(self):
        if self.eig_v_eps == []:
            self.add_eigen_values()
            return SP.Loss_Func_test_end(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
        return SP.Loss_Func_test_end(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
    ...
    def add_loss_func_test2(self):
        if self.eig_v_eps == []:
            self.add_eigen_values()
            return SP.Loss_Func_test0(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
        return SP.Loss_Func_test0(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)

    def add_loss_func_test3(self):
        if self.eig_v_eps == []:
            self.add_eigen_values()
            return SP.Loss_Func_test_start(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
        return SP.Loss_Func_test_start(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
    
    def add_loss_func_test4(self):
        if self.eig_v_eps == []:
            self.add_eigen_values()
            return SP.Loss_Func_test5(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
        return SP.Loss_Func_test5(self.eig_v_eps, self.eig_rvec_eps, self.eig_lvec_eps)
